...
func PALL_(p *Periph) RMAPPROTECT {
...
func PROTECT_(p *Periph) RMNFCPINS {
...
func CPUNIDEN_(p *Periph) RMDEBUGCTRL {
	return RMDEBUGCTRL{mmio.UM32{&p.DEBUGCTRL.U32, uint32(CPUNIDEN)}}
}

func CPUFPBEN_(p *Periph) RMDEBUGCTRL {
