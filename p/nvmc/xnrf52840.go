...
func (rm RMERASEPAGEPARTIALCFG) Load() ERASEPAGEPARTIALCFG {
	return ERASEPAGEPARTIALCFG(rm.UM32.Load())
}
func (rm RMERASEPAGEPARTIALCFG) Store(b ERASEPAGEPARTIALCFG) { rm.UM32.Store(uint32(b)) }

func DURATION_(p *Periph) RMERASEPAGEPARTIALCFG {
...
func CACHEEN_(p *Periph) RMICACHECNF {
	return RMICACHECNF{mmio.UM32{&p.ICACHECNF.U32, uint32(CACHEEN)}}
}

func CACHEPROFEN_(p *Periph) RMICACHECNF {
