...
func PUBLIC_(p *Periph) RMDEVICEADDRTYPE {
...
func PART_(p *Periph) RMINFO_PART {
...
func VARIANT_(p *Periph) RMINFO_VARIANT {
...
func PACKAGE_(p *Periph) RMINFO_PACKAGE {
...
func FLASH_(p *Periph) RMINFO_FLASH {
...
func PTEST_(p *Periph, n int) RMPRODTEST {
...
func A_(p *Periph, n int) RMTEMP_A {
...
func B_(p *Periph, n int) RMTEMP_B {
...
func T_(p *Periph, n int) RMTEMP_T {
