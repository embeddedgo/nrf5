...
import "github.com/embeddedgo/nrf5/hal/te"
...
func LoadLFCLKSRCCOPY() Source {
	return Source(r().lfclksrccopy.LoadBits(3))
}

// LoadLFCLKSRC returns clock source for LFCLK.
func LoadLFCLKSRC() Source {
	return Source(r().lfclksrc.LoadBits(3))
}
...
func LoadCTIV() int {
	return int(r().ctiv.LoadBits(0x7f) * 250)
}
...
func LoadXTALFREQ() XtalFreq {
	return XtalFreq(r().xtalfreq.LoadBits(0xff))
}
